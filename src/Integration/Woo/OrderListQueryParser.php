...
final class OrderListQueryParser
{
    /** @var list<string> */
    ...
    public function __construct(
        array $allowedFields,
        array $allowedSort = ['date_created', 'date_modified', 'id', 'total'],
    ...
    public function parse(mixed $request): OrderListQuery
    {
        ...
        $customerId = $this->parseOptionalInt($params['customer_id'] ?? null, 'customer_id');
    ...
    {
        $allowed = ['fields', 'status', 'customer_id', 'search', 'sort', 'page', 'per_page'];
    ...
    private function parseOptionalInt(mixed $value, string $field): ?int
    {
        if ($value === null || $value === '') {
            return null;
        }
