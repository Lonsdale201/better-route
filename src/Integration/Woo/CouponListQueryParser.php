...
final class CouponListQueryParser
{
    /** @var list<string> */
    ...
    public function __construct(
        array $allowedFields,
        array $allowedSort = ['date_created', 'date_modified', 'id', 'code'],
    ...
    {
        $allowed = ['fields', 'code', 'search', 'sort', 'page', 'per_page'];
